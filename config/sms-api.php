...
return [
    ...
    'default' => env('SMS_SENT_API_GATEWAY', 'sms_sent_logs_gateway'), //Choose default gateway

    //Basic Gateway Sample Configuration
    env('SMS_SENT_API_GATEWAY') => [
        'method' => 'GET', //Choose Request Method (GET/POST) Default:GET
        'url' => env('BASE_URL'), //Base URL
        'params' => [
    ...
    env('SEND_SMS_API_GATEWAY') => [
        'method' => 'POST', //Choose Request Method (GET/POST) Default:GET
        'url' => env('SEND_SINGLE_SMS_BASE_URL'), //Base URL
        'params' => [
        ...
        //'jsonToArray' => true, // OPTIONAL, use only if you want "to" param as text instead of array in JSON payload.
