            ...
            <div class="page-wrap">
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Copyright © {{date('Y')}} MUCU ALUMNI WELFARE.</span>
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Powerd by <a href="https://www.cybrexsystems.com/" class="text-dark" target="_blank">CYBREX SYSTEMS</a></span>
                    </div>
                </footer>  
            </div>
        </div>   
