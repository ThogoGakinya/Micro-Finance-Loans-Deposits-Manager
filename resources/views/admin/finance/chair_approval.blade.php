                                        ...
                                        @method('put')
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="chair_id" value="{{ Auth::user()->id }}" id="target" placeholder="Enter Amount" maxlength="4">
                                                        <input type="hidden" name="chair_approval_status" value="1" id="target" placeholder="Enter Amount" maxlength="4">
                                                        <input type="hidden" name="chair_approval_date" value="{{date('Y-m-d')}}" id="target" placeholder="Enter Amount" maxlength="4">
                                                        ...
                                                        <input type="hidden" name="process_status" value="100" id="target" placeholder="Enter Amount" maxlength="4" required>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <!-- /.card-body -->
                                                     <div class="modal-footer justify-content-between">
                                                        ...
                                                        @if($requisition->treasurer_approval_status == 0)
                                                        <button type="button" class="btn btn-danger btn-xs"><i class="adding fa fa-times"></i>&nbsp;&nbsp;<i>Please wait for treasurer's approval</i></button>
                                                        @else
                                                           @if($requisition->chair_approval_status == 0)
