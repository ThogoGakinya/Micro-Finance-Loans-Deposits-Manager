...
class PaymentEmailNoficationToTreasurer extends Notification
{
    ...
    public function getMessage()
    {
        ...
        return (new MailMessage)
            ...
            ->greeting('Hello,')
            ->line( new HtmlString('We would like to inform you that a new Payment of ' .'<b>'. 'Ksh '.number_format($lastRecord->amount).'</b>'.' for <b>'.$account->account_name.'</b>'.' has been made on ' .'<b>'.$date.'</b>'.' at '.'<b>'.$time.'</b>'))
            ->line(new HtmlString('<strong>MPESA Transaction ID: </strong><b style="color:green;">'.$lastRecord->transaction_id.'</b>'))
